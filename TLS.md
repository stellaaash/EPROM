...
tags:
  - protocol
---
The TLS (Transport Layer Security) protocol is a cryptographic protocol designed to provide communcations security over a network, like the Internet.
