...
# Security
It's good enough for non-critical systems such as monitoring software and other uses, but if you know your system might be the direct target for attacks, you might consider stronger alternatives such as [[TLS]] certificates.
