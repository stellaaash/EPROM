...
In HTTP and friends, **it is primarely used to figure out the type of a resource being transmitted, and if the receiving party can actually process that resource correctly**.
